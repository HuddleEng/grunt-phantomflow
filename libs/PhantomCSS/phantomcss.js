...
var _results = '.'+fs.separator+'screenshots'; // for BC results and src are the same - but you can change it!
...
function compareAll(exclude, list){
	...
	_diffsToProcess.forEach(function(file){
		...
		var html = _libraryRoot+fs.separator+"resemblejscontainer.html";
		var test = {
			filename: baseFile
		};
